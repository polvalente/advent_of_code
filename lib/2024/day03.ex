defmodule AOC2024.Day3 do
  ...
  ## Examples
      ...
      iex> AOC2024.Day3.part1(AOC2024.Day3.test_input())
      161

      iex> AOC2024.Day3.part1(AOC2024.Day3.input())
      155955228
  """
  def part1(input) do
    AOC2024.Day3.Part1.run(input)
  end

  @doc """
  ## Examples

      iex> AOC2024.Day3.part2(AOC2024.Day3.test_input())
      48

      iex> AOC2024.Day3.part2(AOC2024.Day3.input())
      100189366
  """
  def part2(input) do
    AOC2024.Day3.Part2.run(input)
  end
end
