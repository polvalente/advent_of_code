defmodule AOC2024.Day21 do
  ...
  @doc """
  iex> AOC2024.Day21.part1(AOC2024.Day21.test_input())
  126384

  iex> AOC2024.Day21.part1(AOC2024.Day21.input())
  188384
  """
  def part1(input) do
  ...
  @doc """
  iex> AOC2024.Day21.part2(AOC2024.Day21.test_input())
  154115708116294

  iex> AOC2024.Day21.part2(AOC2024.Day21.input())
  232389969568832
  """
  def part2(input) do
    for code <- parse(input), reduce: 0 do
