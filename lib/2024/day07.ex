defmodule AOC2024.Day7 do
  ...
  @doc """
      iex> AOC2024.Day7.part1(AOC2024.Day7.test_input())
      3749

      iex> AOC2024.Day7.part1(AOC2024.Day7.input())
      1298103531759
  """
  def part1(input) do
  ...
  @doc """
      iex> AOC2024.Day7.part2(AOC2024.Day7.test_input())
      11387

      iex> AOC2024.Day7.part2(AOC2024.Day7.input())
      140575048428831
  """
  def part2(input) do
    for {result, operands} <- parse(input) do
