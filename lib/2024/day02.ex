defmodule AOC2024.Day2 do
  ...
  ## Examples
      ...
      iex> AOC2024.Day2.part1(AOC2024.Day2.test_input())
      2

      iex> AOC2024.Day2.part1(AOC2024.Day2.input())
      510
  """
  def part1(input) do
    ts = parse(input)
  ...
  ## Examples
      ...
      iex> AOC2024.Day2.part2(AOC2024.Day2.test_input())
      4

      iex> AOC2024.Day2.part2(AOC2024.Day2.input())
      553
  """
  def part2(input) do
    ts = parse(input)
