defmodule AOC2024.Day4 do
  ...
  ## Examples
      ...
      iex> AOC2024.Day4.part1(AOC2024.Day4.test_input())
      18

      iex> AOC2024.Day4.part1(AOC2024.Day4.input())
      2434
  """
  def part1(input) do
    t = parse(input)
  ...
  ## Examples
      ...
      iex> AOC2024.Day4.part2(AOC2024.Day4.test_input())
      9

      iex> AOC2024.Day4.part2(AOC2024.Day4.input())
      1835
  """
  def part2(input) do
    matrix = parse(input)
