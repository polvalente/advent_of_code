defmodule Day24 do
  ...
  @doc """
  iex> Day24.part1(Day24.test_input())
  4

  iex> Day24.part1(Day24.test_input2())
  2024

  iex> Day24.part1(Day24.input())
  51410244478064
  """
  def part1(input) do
  ...
  defp expected_result(i) do
    # For position i, when both inputs are 1:
    # Result should be 0 with carry 1
    {0, 1}
  end
end
