defmodule Day22 do
  ...
  @doc """
  iex> Day22.part1(Day22.test_input())
  37327623

  iex> Day22.part1(Day22.input())
  19927218456
  """
  def part1(input) do
  ...
  @doc """
  iex> Day22.part2(Day22.test_input())
  24

  iex> Day22.part2(Day22.test_input2())
  23

  iex> Day22.part2(Day22.input())
  2189
  """
  def part2(input) do
    changes_and_prices =
